r"""MeetUp 228 - Beginners' Python and Machine Learning - 04 Feb 2026 - f-strings for absolute beginners
...
Links:
- Colab: <https://colab.research.google.com/drive/1YrFnmvsTSOXPMsx-rxHXaTypYLaJSSiN>
- Youtube: <https://youtu.be/KobyxOySY8I>
- Meetup:  <https://www.meetup.com/beginners-python-machine-learning/events/313108824/>
- Github:  <https://github.com/timcu/bpaml-sessions/tree/master/online>

@author D Tim Cummings

This session will show you how to use the f-strings to format all text output. They were introduced in Python 3.6 and quickly became the formatting and string building method of choice.
...
print("\nNew in python 3.12 - multiline f-strings (including comments)")
data = [
    'Item A ', # First item
    ' Item B  ', # Second item
    '  Item C'  # Third item
]
formatted_string = f"Playlist: {', '.join([
    item.strip() for item in data # Use strip to clean up whitespace
])}"
print(formatted_string)

print("\nNew in python 3.12 - able to use \\ and same quote character as opening quote character in f-strings")
words = ["Hello", "World"]
print(f"Items: {"\n".join(words)}")
