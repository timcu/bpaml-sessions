r"""MeetUp 223 - Beginners' Python and Machine Learning - 01 Oct 2025 - Introduction to Coding

Learning objectives:
- Interactive python
- Introduction to coding
- Branching, looping, list comprehension

Links:
- Colab:   <https://colab.research.google.com/drive/1d9ELXow-R6cwsflrRUhUO4rRM9eIrAmY>
- Youtube: <https://youtu.be/pLbJ0Fo4mCw>
- Meetup:  <https://www.meetup.com/beginners-python-machine-learning/events/311149330/>
...
- Alternatively install Python 3.13.7 from https://www.python.org/downloads/
 ...
 - Additionally install IDE such as PyCharm 2025.2 from https://www.jetbrains.com/pycharm/download/
